  ...
  <objTree dataType="Struct" type="Duality.GameObject" id="3399078172">
    ...
    <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2073925019">
      <_items dataType="Array" type="Duality.Component[]" id="2054570902" length="8">
        ...
        <item dataType="Struct" type="Soulstone.Duality.Plugins.Blue.AlphaGlider" id="3901035865">
          <_current />
          <_original dataType="Float">0.2</_original>
          <_queue dataType="Struct" type="System.Collections.Generic.Queue`1[[Soulstone.Duality.Plugins.Blue.AlphaGlider+Step]]" id="3789249593">
            <_array dataType="Array" type="Soulstone.Duality.Plugins.Blue.AlphaGlider+Step[]" id="2229197006" length="0" />
        ...
        <item dataType="Struct" type="Soulstone.Duality.Plugins.Blue.Background" id="2678133902">
        ...
        <item dataType="Struct" type="Soulstone.Duality.Plugins.Blue.Button" id="775132658">
    ...
    <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="3410865768" surrogate="true">
      ...
      <body>
        <keys dataType="Array" type="System.Object[]" id="1523668721">
          ...
          <item dataType="Type" id="1778160926" value="Soulstone.Duality.Plugins.Blue.AlphaGlider" />
          <item dataType="Type" id="1891728858" value="Soulstone.Duality.Plugins.Blue.Input.MouseListener" />
          <item dataType="Type" id="627921230" value="Soulstone.Duality.Plugins.Blue.Button" />
          <item dataType="Type" id="1595050986" value="Duality.Components.Renderers.TextRenderer" />
          <item dataType="Type" id="3913243582" value="Soulstone.Duality.Plugins.Blue.Background" />
        </keys>
        <values dataType="Array" type="System.Object[]" id="345083872">
          ...
          <item dataType="ObjectRef">3901035865</item>
          <item dataType="ObjectRef">1046470453</item>
          <item dataType="ObjectRef">775132658</item>
          <item dataType="ObjectRef">4282015826</item>
          <item dataType="ObjectRef">2678133902</item>
        </values>
      </body>
    </compMap>
